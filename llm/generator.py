...
class LLMGenerator:
    ...
    def _build_wireframe_prompt(self, lessons: str = "") -> str:
        ...
        prompt = (
            ...
            "  p.set_color(r, g, b)                       # wireframe line color\n"
            "  p.run(func)                                # func(x, y) -> z, starts loop\n\n"
            "Background is always white with a black bounding box.\n"
            "Pick a fun line color — any RGB you like (e.g. vivid blue, deep red,\n"
            "forest green, hot pink). Avoid pure black (it would match the bbox).\n\n"
            ...
            "  p.set_color(30, 100, 200)  # deep blue\n"
            "  def surface(x, y):\n"
